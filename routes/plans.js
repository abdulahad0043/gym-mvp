...
/**
 * PUT /api/plans/assign-plan
 * Body: { memberId, diet_plan, workout_plan, note? }
 * Updates the live plan on the Member doc AND logs the assignment.
 */
router.put('/assign-plan', async (req, res, next) => {
  try {
    ...
    // Update live plan on the member
...
/**
 * GET /api/plans/:memberId
 * Returns full plan-assignment history for a member.
 */
